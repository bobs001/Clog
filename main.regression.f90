...
!
    ...
    SUBROUTINE test_plasma(nni, ep, zp, mp, betab, zb, mb, nb, scale) 
      ...
      READ(1,'(2E25.14)')  te_dat, ti_dat
      READ(1,'(10E25.14)') nb_dat
      READ(1,'(10E25.14)') mb_dat
...
!
    SUBROUTINE write_acoeff_bps_mass(nni,ep,zp,mp,betab,zb,mb,nb,scale)
      ...
      WRITE(6,'(54A)') 'subroutine check: bps_acoeff_ei_mass [A]=[keV/cm]'
      WRITE(6,'(3E25.14)') a_tot, a_i, a_e
      WRITE(6,'(3E25.14)') ac_tot, ac_i, ac_e
      WRITE(6,'(3E25.14)') aq_tot, aq_i, ac_e
      WRITE(1,'(54A)') 'subroutine check: bps_acoeff_ei_mass [A]=[keV/cm]'
    ...
    SUBROUTINE test_acoeff_bps_mass(nni,ep,zp,mp,betab,zb,mb,nb,scale)
      ...
      WRITE(6,*) 'calling: test_acoeff_bps_mass ...'
    ...
    SUBROUTINE write_ccoeff_bps_mass(nni,ep,zp,mp,betab,zb,mb,nb,scale)
      ...
      CALL bps_ccoeff_ei_mass(nni, scale, ep, zp, mp, betab, zb, mb, nb, &
         c_tot, c_i, c_e, cc_tot, cc_i, cc_e, cq_tot, cq_i, cq_e,        &
         cc_s_e, cc_r_e, cc_s_i, cc_r_i) 
      WRITE(6,'(54A)') 'subroutine check: bps_ccoeff_ei_mass [C]=[keV^2-s/cm^2]'
      WRITE(6,'(3E25.14)') c_tot, c_i, c_e
      WRITE(6,'(3E25.14)') cc_tot, cc_i, cc_e
      WRITE(6,'(3E25.14)') cq_tot, cq_i, cc_e
      WRITE(1,'(54A)') 'subroutine check: bps_ccoeff_ei_mass [C]=[keV^2-s/cm^2]'
      WRITE(1,'(3E25.14)') c_tot, c_i, c_e
      WRITE(1,'(3E25.14)') cc_tot, cc_i, cc_e
      WRITE(1,'(3E25.14)') cq_tot, cq_i, cq_e
    END SUBROUTINE write_ccoeff_bps_mass

    SUBROUTINE test_ccoeff_bps_mass(nni,ep,zp,mp,betab,zb,mb,nb,scale)
                                                         ! Plasma:
      INTEGER,                     INTENT(IN)  :: nni    !  number of ions
      REAL,    DIMENSION(1:nni+1), INTENT(IN)  :: betab  !  temp array    [1/keV]
      REAL,    DIMENSION(1:nni+1), INTENT(IN)  :: mb     !  mass array    [keV]
