...
\\[10pt]
  ...
  \left( \frac{\beta_b m_b v_a^2}{2\pi} \right)^{1/2} \, \frac{1}{\beta_b v_a}
...
\\[10pt]
  ...
  \left( \frac{\beta_b m_b v_p^2}{2\pi} \right)^{1/2} \! \!
   \frac{1}{\beta_b v_a}
  \int_0^\infty du \, 
  \bigg\{ {\rm Re} \, \psi \left( 1 + i \frac{\eta_{ab}}{u}
  \right)
   - 
   \ln \frac{\eta_{ab}}{u}  \bigg\}
\nonumber\\
  &&
  \Bigg[ \exp\left\{ - \frac{1}{2}\, \beta_b
  m_b v_a^2 \left(u-1 \right)^2\right\} 
%\nonumber\\
 % && \qquad\qquad\quad
  - \exp\left\{ - \frac{1}{2} \beta_b m_b v_a^2 \left( u + 1\right)^2\right\} 
\Bigg]	\,.
\label{regb}
\end{eqnarray}
%% 
...
%%
\begin{eqnarray}
\eta_{ab}= \frac{e_a e_b}{4\pi\hbar v_{a}} \ .
\end{eqnarray}
%%
...
\begin{eqnarray}
  ...
  \frac{1}{\beta_b v_p}
  \int_0^\infty du\, 
  \Big[{\rm Re}\,\psi\!\left\{ 1 + i\, \frac{\eta_{pb}}{u}
  \right\}
  - \ln\!\left\{\frac{\eta_{pb}}{u} \right\} \Big] 
\nonumber
\\ && \hskip2.5cm
