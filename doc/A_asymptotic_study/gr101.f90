...
!
! plot the regular and singular contribuitons
!
...
!!          WRITE(6, '(I5,10E12.4)') iu, ep, a_tot, a_e, a_i, ac_tot, ac_e, ac_i, aq_tot, aq_e, aq_i
           ...
           WRITE(3, '(I5,10E12.4)') iu, ep, a_tot_lim, a_e_lim, a_i_lim, ac_tot_lim, ac_e_lim, &
              ac_i_lim, aq_tot_lim, aq_e_lim, aq_i_lim
           WRITE(6, '(I5,10E12.4)') iu, ep, a_tot_lim, a_e_lim, a_i_lim, ac_tot_lim, ac_e_lim, &
              ac_i_lim, aq_tot_lim, aq_e_lim, aq_i_lim
        ENDDO
!
...
!
! Retirms the plasma species arrays: betab, mb, nb, zb
! Allocates other plasma arrays
!
    SUBROUTINE define_plasma(te, ti, ne)
    USE allocatablevars 
    USE physvars
      IMPLICIT NONE
      REAL                                :: te     ! [keV]
...
!
      ...
      WRITE(6,*) "#"
      WRITE(6,*) "# iu, ep, a_tot, a_e, a_i, ac_tot, ac_e, ac_i, aq_tot, aq_e, aq_i"
      WRITE(1,'(A)') "#"
